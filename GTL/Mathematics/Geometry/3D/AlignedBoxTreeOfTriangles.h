...
{
    template <typename T>
    class AlignedBoxTreeOfTriangles : public BVTreeOfTriangles<T, AlignedBoxBV<T>>
    {
    public:
        AlignedBoxTreeOfTriangles()
            :
            BVTreeOfTriangles<T, AlignedBoxBV<T>>{}
        {
        }
    ...
    private:
        friend class UnitTestAlignedBoxTreeOfTriangles;
    };
}
