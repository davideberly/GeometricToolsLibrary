...
namespace gtl
{
    ...
    public:
        ...
        inline APType operator[](std::size_t i) const
        {
            return mEndpoints[i];
        }
        ...
        // arbitrary-precision number that represents +infinity. A sign of -2
        // is a signal that NegInf() is an arbitrary-precision number that
        // represents -infinity.
        inline static APType PosInf()
        {
            APType posInf(0);
            posInf.SetSign(+2);
            return posInf;
