...
namespace gtl
{
    ...
    public:
        ...
        RootsBisection2(std::size_t xMaxIterations, std::size_t yMaxIterations, std::size_t = 0)
            :
        ...
        RootsBisection2(std::size_t xMaxIterations, std::size_t yMaxIterations, std::size_t precision)
            :
            ...
            T& xRoot, T& yRoot, T& fRoot, T& gRoot)
        {
            ...
            auto XFunction = [this, &F, &G, &yMin, &yMax](T const& x)
            {
                ...
                (void)hasYRoot;  // For use in debugging.
                return F(x, mYRoot);
            };
