...
namespace gtl
{
    ...
    public:
            ...
            PolynomialRoot<T>* roots)
        {
            ...
            std::size_t numRoots = ComputeDepressedRoots(useBisection, rD0, rD1, rRoots.data());
            ...
            PolynomialRoot<T>* roots)
        {
            ...
            std::array<PolynomialRoot<Rational>, 3> rRoots{};
            std::size_t numRoots = ComputeDepressedRoots(useBisection, d0, d1, rRoots.data());
            for (std::size_t i = 0; i < numRoots; ++i)
            {
    ...
    private:
            ...
            PolynomialRoot<T>* roots)
        {
            ...
            if (g1 == zero)
            {
                ...
                {
                    std::size_t numRoots = RootsLinear<T>::Solve(g2, g3, roots);
            ...
            {
                std::size_t numRoots = RootsQuadratic<T>::Solve(useBisection, g1, g2, g3, roots);
            ...
            PolynomialRoot<T>* roots)
        {
            ...
            if (m1 == zero)
            {
                ...
                {
                    std::size_t numRoots = RootsLinear<T>::Solve(m2, roots);
                    roots[numRoots++] = { zero, 2 };
                    std::sort(roots, roots + numRoots);
                    return numRoots;
                }
            ...
            {
                std::size_t numRoots = RootsQuadratic<T>::Solve(useBisection, m1, m2, roots);
                roots[numRoots++] = { zero, 1 };
                std::sort(roots, roots + numRoots);
                return numRoots;
            }
            ...
            PolynomialRoot<Rational>* rRoots)
        {
            ...
            if (signD0 == 0)
            {
                ...
                else if (signD1 < 0)
                {
                    ...
                    std::size_t numRoots = RootsQuadratic<T>::ComputeDepressedRoots(
                        true, rD1, rRoots);
