...
{
    template <typename T>
    class ApprHelmertTransformation3
    {
    public:
        ...
        std::size_t Fit(std::vector<Vector3<T>> const& p, std::vector<Vector3<T>> const& q,
            ...
            T& function)
        {
            ...
            MakeIdentity(mRotate);
            MakeIdentity(mRotate0);
            MakeIdentity(mRotate1);
            MakeIdentity(mRotate2);
    ...
    private:
        friend class UnitTestApprHelmertTransformation3;
    };
}
