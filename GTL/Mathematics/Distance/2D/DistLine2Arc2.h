...
// 1 or 2. If output.numClosestPairs is 1, output.parameter[0] is the line
...
// output.parameter[0] and output.parameter[1] are the line t-values for its
...
namespace gtl
{
    ...
    public:
        ...
        Output operator()(Line2<T> const& line, Arc2<T> const& arc)
        {
            Output output{};
