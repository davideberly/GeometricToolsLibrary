...
namespace gtl
{
    ...
    public:
        ...
        {
            Control(
                std::size_t inMaxSubdivisions = 8,
                std::size_t inMaxBisections = 128,
            ...
            std::size_t maxSubdivisions;
            std::size_t maxBisections;
            T epsilon;
            T tolerance;
        };
    ...
    private:
        friend class UnitTestDistOrientedBox3Cone3;
    };
}
