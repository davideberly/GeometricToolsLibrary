...
namespace gtl
{
    ...
    public:
        ...
        Output operator()(Vector3<T> const& point, Parallelepiped3<T> const& ppd)
        {
            Output output{};
    ...
    private:
        ...
        Vector3<T> GetClosestRzzm(Matrix3x3<T> const& A3, Vector3<T> const& Z3)
        {
            ...
            Vector2<T> Zeta2 = Z2 - u * (GetInverse(A2) * V2);
