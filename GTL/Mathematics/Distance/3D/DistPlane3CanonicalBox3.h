...
namespace gtl
{
    ...
    private:
        ...
        static void DoQuery2D(std::size_t i0, std::size_t i1, std::size_t i2,
        ...
        static void DoQuery1D(std::size_t i0, std::size_t i1, std::size_t i2,
    ...
    private:
        friend class UnitTestDistPlane3CanonicalBox3;
    };
}
