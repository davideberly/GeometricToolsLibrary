...
namespace gtl
{
    ...
    private:
        static void Face(std::size_t i0, std::size_t i1, std::size_t i2, Vector3<T>& origin,
        ...
        static void DoQuery2D(std::size_t i0, std::size_t i1, std::size_t i2, Vector3<T>& origin,
        ...
        static void DoQuery1D(std::size_t i0, std::size_t i1, std::size_t i2, Vector3<T>& origin,
            Vector3<T> const& direction, Vector3<T> const& extent, Output& output)
        {
    ...
    private:
        friend class UnitTestDistLine3CanonicalBox3;
    };
}
