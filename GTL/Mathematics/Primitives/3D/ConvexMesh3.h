...
namespace gtl
{
    ...
    {
    public:
        static std::size_t constexpr CFG_EMPTY = 0x00000000;
        static std::size_t constexpr CFG_POINT = 0x00000001;
        static std::size_t constexpr CFG_SEGMENT = 0x00000002;
        static std::size_t constexpr CFG_POLYGON = 0x00000004;
        static std::size_t constexpr CFG_POLYHEDRON = 0x00000008;
