...
namespace gtl
{
    ...
    public:
        ...
        Polyhedron3(std::size_t inNumVertices, std::size_t inNumTriangles, bool inCounterClockwise)
            :
            ...
            counterClockwise(inCounterClockwise)
        {
            ...
            std::map<std::size_t, std::size_t> vmap{};
        ...
        T ComputeSurfaceArea() const
        {
            ...
            auto triangles = reinterpret_cast<std::array<std::size_t, 3> const*>(indices.data());
            for (std::size_t t = 0; t < numTriangles; ++t)
            {
                std::size_t v0 = triangles[t][0];
                std::size_t v1 = triangles[t][1];
                std::size_t v2 = triangles[t][2];
