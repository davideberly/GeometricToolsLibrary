...
namespace gtl
{
    ...
    public:
        ...
        // must be in {0,1,2,3}.
        static inline std::array<std::size_t, 3> const& GetFaceIndices(std::size_t face)
        {
            static std::array<std::array<std::size_t, 3>, 4> const sFaceIndices =
            { {
                { 0, 2, 1 },
                { 0, 1, 3 },
                { 0, 3, 2 },
        ...
        static inline std::array<std::size_t, 12> const& GetAllFaceIndices()
        {
            static std::array<std::size_t, 12> sAllFaceIndices =
            {
                0, 2, 1,
                0, 1, 3,
                0, 3, 2,
        ...
        static inline std::array<std::size_t, 2> const& GetEdgeIndices(std::size_t edge)
        {
            static std::array<std::array<std::size_t, 2>, 6> sEdgeIndices =
            { {
                { 0, 1 },
                { 0, 2 },
                { 0, 3 },
        ...
        static inline std::array<std::size_t, 12> const& GetAllEdgeIndices()
        {
            static std::array<std::size_t, 12> sAllEdgeIndices =
            {
        ...
        static inline std::array<std::size_t, 4> const& GetEdgeAugmented(std::size_t edge)
        {
            static std::array<std::array<std::size_t, 4>, 6> sEdgeAugmented =
            { {
                { 0, 1, 2, 3 },
                { 0, 2, 3, 1 },
                { 0, 3, 1, 2 },
        ...
        static inline std::array<std::size_t, 4> const& GetVertexAugmented(std::size_t vertex)
        {
            static std::array<std::array<std::size_t, 4>, 4> sVertexAugmented =
            { {
                { 0, 1, 3, 2 },
                { 1, 3, 0, 2 },
                { 2, 1, 0, 3 },
        ...
        Vector3<T> ComputeFaceNormal(std::size_t face) const
        {
