...
namespace gtl
{
    ...
    public:
        ...
        Output operator()(Halfspace3<T> const& halfspace, Sphere3<T> const& sphere)
        {
            Output output{};
            ...
            output.intersect = (center + sphere.radius >= C_<T>(0));
            return output;
        }

    private:
        friend class UnitTestIntrHalfspace3Sphere3;
    };
}
