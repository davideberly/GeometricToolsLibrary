...
namespace gtl
{
    ...
    public:
        ...
        IntpHermiteCubic1(std::array<Sample, 2> const& blocks)
            :
            c{}
        {
            Generate(blocks);
        ...
        // following where 'hermite' is of type IntpHermiteCubic1<T>:
        //   H(x) = hermite(0, x)
        //   Hx(x) = hermite(1, x)
        //   Hxx(x) = hermite(2, x)
        //   Hxxx(x) = hermite(3, x)
    ...
    public: // For internal use in IntpHermiteCubic{2,3}.
