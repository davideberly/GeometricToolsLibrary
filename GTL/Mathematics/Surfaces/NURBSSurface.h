...
namespace gtl
{
    ...
    public:
        ...
        void SetWeight(std::size_t i0, std::size_t i1, T const& weight)
        {
            GTL_ARGUMENT_ASSERT(
                i0 < GetNumControls(0) && i1 < GetNumControls(1),
                "Invalid index.");
        ...
        T const& GetWeight(std::size_t i0, std::size_t i1) const
        {
            GTL_ARGUMENT_ASSERT(
                i0 < GetNumControls(0) && i1 < GetNumControls(1),
                "Invalid index.");
    ...
    protected:
        ...
        void Compute(std::size_t uOrder, std::size_t vOrder, std::size_t iumin, std::size_t iumax,
            std::size_t ivmin, std::size_t ivmax, Vector<T, N>& X, T& w) const
        {
            ...
            for (std::size_t iv = ivmin; iv <= ivmax; ++iv)
            {
                ...
                for (std::size_t iu = iumin; iu <= iumax; ++iu)
                {
                    ...
                    std::size_t index = ju + numControls0 * jv;
