...
namespace gtl
{
    ...
    public:
        ...
        static std::size_t constexpr invalid = 0;

        // The solution is unique.
        static std::size_t constexpr unique = 1;

        // The solution is not unique. A sum of angles is constant.
        static std::size_t constexpr nonUniqueSum = 2;

        // The solution is not unique. A difference of angles is constant.
        static std::size_t constexpr nonUniqueDifference = 3;
        ...
        EulerAngles(std::size_t i0, std::size_t i1, std::size_t i2)
            :
            axis{ i0, i1, i2 },
            angle{ C_<T>(0), C_<T>(0), C_<T>(0) },
            result(unique)
        ...
        EulerAngles(std::size_t i0, std::size_t i1, std::size_t i2, T const& a0, T const& a1, T const& a2)
            :
            axis{ i0, i1, i2 },
            angle{ a0, a1, a2 },
            result(unique)
