...
namespace gtl
{
    ...
    public:
        ...
        NaturalCubicSpline(bool isFree, std::size_t numPoints,
            ...
            mDelta{}
        {
            ...
            std::size_t const numBElements = 3 * numPm1;
        ...
        NaturalCubicSpline(std::size_t numPoints, Vector<T, N> const* f0,
    ...
    private:
            ...
            Matrix3x3<T>& R, std::vector<Vector<T, N>>& B)
        {
            ...
            for (std::size_t i0 = 0, i1 = 1; i0 <= numPm3; i0 = i1++)
            {
                ...
                for (std::size_t j = 0, k = 3 * i0; j < 3; ++j, ++k)
                {
                    B[k] = coeff[j] * diff;
                }
            }
        ...
        void Solve(std::size_t ell10, std::size_t ell21, std::size_t numPoints,
        ...
        void RowReduce(std::size_t ell10, std::size_t ell21, std::size_t numPoints,
            Matrix3x3<T>& R, std::vector<Vector<T, N>>& B)
        {
    ...
    private:
        friend class UnitTestNaturalCubicSpline;
    };
}
