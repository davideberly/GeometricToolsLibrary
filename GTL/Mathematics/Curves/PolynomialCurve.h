...
namespace gtl
{
    ...
    {
    public:
        // The default constructor creates a polynomial curve with all
        // components set to the constant zero (all degree-0 polynomials).
        // You can set these to other polynomials using member accessors.
        ...
        // Member access.
        void SetPolynomial(std::size_t i, Polynomial1<T> const& poly)
        {
            mPolynomial[i] = poly;
        ...
        inline Polynomial1<T> const& GetPolynomial(std::size_t i) const
        {
            return mPolynomial[i];
        }

        inline Polynomial1<T> const& GetDer1Polynomial(std::size_t i) const
        {
            return mDer1Polynomial[i];
        }

        inline Polynomial1<T> const& GetDer2Polynomial(std::size_t i) const
        {
            return mDer2Polynomial[i];
        }

        inline Polynomial1<T> const& GetDer3Polynomial(std::size_t i) const
        {
    ...
    private:
        friend class UnitTestPolynomialCurve;
    };
}
