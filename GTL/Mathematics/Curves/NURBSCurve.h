...
namespace gtl
{
    ...
    public:
        ...
        void SetWeight(std::size_t i, T weight)
        {
            GTL_ARGUMENT_ASSERT(
                i < GetNumControls(),
                "Invalid index.");
        ...
        T const& GetWeight(std::size_t i) const
        {
            GTL_ARGUMENT_ASSERT(
                i < GetNumControls(),
                "Invalid index.");
    ...
    protected:
        ...
        void Compute(std::size_t order, std::size_t imin, std::size_t imax, Vector<T, N>& X, T& w) const
        {
    ...
    private:
        friend class UnitTestNURBSCurve;
    };
}
