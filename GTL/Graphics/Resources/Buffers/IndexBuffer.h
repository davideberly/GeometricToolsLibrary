...
// Expose this define to test for mismatches of primitive type in
// {Set,Get}Point, {Set,Get}Segment and {Set,Get}Triangle.
//
//#define GTL_VERIFY_PRIMITIVE_TYPE
...
namespace gtl
{
    ...
    public:
        ...
        // GTL_VERIFY_PRIMITIVE_TYPE.  These functions have per-primitive
    ...
    protected:
        inline bool ValidPrimitiveType(IPType type) const
        {
            ...
            {
#if defined(GTL_VERIFY_PRIMITIVE_TYPE)
                GTL_RUNTIME_ERROR("Invalid primitive type used in Set<Primitive> call.");
#else
                return false;
#endif
            }
