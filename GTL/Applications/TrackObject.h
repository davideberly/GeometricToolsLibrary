...
namespace gtl
{
    ...
    public:
        ...
        inline Matrix3x3<float> const& GetOrientation() const
        {
        ...
        void Attach(std::shared_ptr<Spatial> const& object) const;
        void Detach(std::shared_ptr<Spatial> const& object) const;
    ...
    protected:
        ...
        void NormalizeAndUpdateRoot(Matrix3x3<float>& rotate);
