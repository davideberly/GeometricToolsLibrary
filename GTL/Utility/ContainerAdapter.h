...
namespace gtl
{
    ...
    public:
        ...
        ContainerAdapter(T* elements = nullptr, std::size_t = 0)
            :
            mElements(elements)
        {
            static_assert(
        ...
        inline void reset(T* elements, std::size_t = 0) noexcept
        {
            mElements = elements;
        }
        ...
        inline T const& operator[](std::size_t i) const noexcept
        {
            return mElements[i];
        }
    ...
    private:
        friend class UnitTestContainerAdapter;
    };
}
...
namespace gtl
{
    ...
    public:
        ...
        ContainerAdapter(T* elements = nullptr, std::size_t numElements = 0)
            :
        ...
        inline void reset(T* elements, std::size_t numElements)
        {
            GTL_ARGUMENT_ASSERT(
