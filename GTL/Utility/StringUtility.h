...
namespace gtl
{
    ...
    inline std::string ConvertWideToNarrow(std::wstring const& input)
    {
        ...
        std::transform(input.begin(), input.end(), std::back_inserter(output),
            [](std::wint_t c)
            {
                std::int32_t converted = std::wctob(c);
    ...
    inline std::string ToLower(std::string const& input)
    {
        std::string output{};
        std::transform(input.begin(), input.end(), std::back_inserter(output),
            [](std::int32_t c) { return static_cast<char>(std::tolower(c)); });
        return output;
    }
    ...
    inline std::string ToUpper(std::string const& input)
    {
        std::string output{};
        std::transform(input.begin(), input.end(), std::back_inserter(output),
            [](std::int32_t c) { return static_cast<char>(std::toupper(c)); });
        return output;
    }
    ...
    // 'std::int32_t ch' input) that return 0 or !0.
