...
namespace gtl
{
    ...
    public:
        ...
        inline explicit RawConstIterator(pointer inPointer, std::size_t offset = 0)
            :
        ...
        inline RawConstIterator operator++(std::int32_t)
        {
    ...
    private:
        friend class UnitTestRawConstIterator;
    };
    ...
    public:
        ...
        inline explicit RawIterator(pointer inPointer, std::size_t offset = 0)
            :
        ...
        inline RawIterator operator++(std::int32_t)
        {
