...
namespace gtl
{
    ...
    using TraitSelector = std::enable_if_t<condition, std::size_t>;
    ...
    template <typename T>
    using IsFPType = std::enable_if_t<!is_arbitrary_precision<T>::value, std::size_t>;

    template <typename T>
    using IsAPType = std::enable_if_t<is_arbitrary_precision<T>::value, std::size_t>;
    ...
    template <typename T>
    using IsDivisionType = std::enable_if_t<has_division_operator<T>::value, std::size_t>;

    template <typename T>
    using IsNotDivisionType = std::enable_if_t<!has_division_operator<T>::value, std::size_t>;
}
