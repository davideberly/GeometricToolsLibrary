...
TestDistPoint3Parallelepiped3Window3::TestDistPoint3Parallelepiped3Window3(Parameters& parameters)
    :
    Window3(parameters),
    mQuery{},
    mResult{},
...
void TestDistPoint3Parallelepiped3Window3::OnIdle()
{
    mTimer.Measure();
...
bool TestDistPoint3Parallelepiped3Window3::OnCharPress(uint8_t key, int32_t x, int32_t y)
{
    ...
    case 'a':
        ...
        csPhi = std::cos(mPhi);
        snPhi = std::sin(mPhi);
        mPoint = radius * Vector3<float>{ csPhi* csTheta, csPhi* snTheta, snPhi };
        DoQuery();
        return true;
...
void TestDistPoint3Parallelepiped3Window3::CreateScene()
{
...
void TestDistPoint3Parallelepiped3Window3::CreateMeshFace(std::size_t i, MeshFactory& mf,
...
void TestDistPoint3Parallelepiped3Window3::DoQuery()
{
