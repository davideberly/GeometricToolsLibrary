...
void UnitTestOdeEuler::Test2()
{
    ...
    std::ofstream outFile("Mathematics/DifferentialEquations/PendulumEuler.txt");
    for (std::size_t i = 0; i < output.size(); ++i)
    {
...
#if defined(GTL_USE_MSWINDOWS)
    WICFileIONative::SaveToPNG("Mathematics/DifferentialEquations/PendulumEuler.png",
...
void UnitTestOdeEuler::TestDynamic()
{
    ...
    // Write the approximation solution as text.
    std::ofstream outFile("Mathematics/DifferentialEquations/PendulumEulerD.txt");
    for (std::size_t i = 0; i < output.size(); ++i)
    {
        outFile << "i = " << i << ", " << output[i] << std::endl;
    }
...
#if defined(GTL_USE_MSWINDOWS)
    WICFileIONative::SaveToPNG("Mathematics/DifferentialEquations/PendulumEulerD.png",
        WICFileIONative::R8G8B8A8, numOutputs, numOutputs,
        reinterpret_cast<std::uint8_t*>(canvas.data()));
#endif
}
