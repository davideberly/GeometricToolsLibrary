...
namespace gtl
{
    ...
    public:
        ...
        static constexpr std::uint32_t R10G10B10A2 = 0;
        static constexpr std::uint32_t R10G10B10_XR_BIAS_A2 = 1;
        static constexpr std::uint32_t R32_FLOAT = 2;
        static constexpr std::uint32_t R16G16B16A16 = 3;
        static constexpr std::uint32_t B5G6R5 = 4;
        static constexpr std::uint32_t B5G5R5A1 = 5;
        static constexpr std::uint32_t R1 = 6;
        static constexpr std::uint32_t R8 = 7;
        static constexpr std::uint32_t R16 = 8;
        static constexpr std::uint32_t R8G8B8A8 = 9;
        static constexpr std::uint32_t B8G8R8A8 = 10;
        ...
        using TextureCreator = std::function<std::uint8_t* (std::uint32_t, std::size_t, std::size_t)>;
        ...
        static void Load(std::string const& filename, std::uint32_t& outFormat,
            std::size_t& outWidth, std::size_t& outHeight, std::vector<std::uint8_t>& outTexels);
        ...
        static void Load(void* module, std::string const& rtype, std::int32_t resource,
            std::uint32_t& outFormat, std::size_t& outWidth, std::size_t& outHeight,
        ...
        static void SaveToPNG(std::string const& filename, std::uint32_t inFormat,
            std::size_t inWidth, std::size_t inHeight, std::uint8_t const* inTexels);
        ...
        // compression).
        static void SaveToJPEG(std::string const& filename, std::uint32_t inFormat,
            std::size_t inWidth, std::size_t inHeight, std::uint8_t const* inTexels,
            float imageQuality);
    ...
    private:
        ...
        // JPEG.
        static void SaveTo(std::string const& filename, std::uint32_t inFormat,
            std::size_t inWidth, std::size_t inHeight, std::uint8_t const* inTexels,
            float imageQuality);

        static std::size_t constexpr NUM_FORMATS = 11;
        static std::array<std::uint32_t, NUM_FORMATS> const msBytesPerTexel;
        ...
        static std::size_t constexpr NUM_LOAD_FORMATS = 14;
        ...
        static std::size_t constexpr NUM_SAVE_FORMATS = 11;
